...
import { CenterContainer, MarginContainer, SizeImageContainer, SizePartContainer } from "../../pages/Animals.styles";
...
export const StaffCreateWindow = observer(() => {
    ...
    const save = async () => {
        const code = await staffService.save(images, name, surname, middleName, date, gender?.value === Gender.MALE? 'мужской' : gender?.value === Gender.FEMALE? 'женский' : '')
