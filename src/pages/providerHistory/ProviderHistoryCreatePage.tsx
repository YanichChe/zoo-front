...
const Container = styled.div`
  ...
  width: 100%;
`
const ProviderHistoryCreatePage: React.FC = () => {
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    e.preventDefault();
    const code = await providerHistoryService.createProviderHistory(formData)
    ...
    <>
     <div style={{
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Button type="submit">Создать историю поставки</Button>
      </Form>
      </Container>
    </>
    )}
...
export default ProviderHistoryCreatePage;
