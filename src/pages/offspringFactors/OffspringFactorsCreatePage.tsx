...
const Container = styled.div`
  ...
  width: 100%;
`
const OffspringFactorsCreatePage: React.FC = () => {
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    e.preventDefault();
    const code = await offspringFactorService.createOffspringFactor(formData)
    ...
    <>
     <div style={{
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Button type="submit">Создать фактор размножения особи</Button>
      </Form>
      </Container>
    </>
    )}
...
export default OffspringFactorsCreatePage;
