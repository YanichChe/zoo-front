...
const DietCreatePage: React.FC = () => {
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    e.preventDefault();
    const code = await dietService.createDiet(formData)
    ...
    <>
     <div style={{
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Button type="submit">Создать рацион животному</Button>
      </Form>
      </Container>
    </>
    )}
