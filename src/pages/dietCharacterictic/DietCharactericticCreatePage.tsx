...
const Container = styled.div`
  ...
  width: 100%;
`
const DietCharacteristicCreatePage: React.FC = () => {
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    e.preventDefault();
    const code = await dietCharacteristicService.createDietCharacteristic(formData)
    ...
    <>
     <div style={{
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Button type="submit">Создать характеристику</Button>
      </Form>
      </Container>
    </>
    )}
...
export default DietCharacteristicCreatePage;
