...
const Container = styled.div`
  ...
  width: 100%;
`
const IndividualHistoryCreatePage: React.FC = () => {
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    e.preventDefault();
    const code = await individualHistoryService.createIndividualHistory(formData)
    ...
    <>
     <div style={{
      ...
      <Form onSubmit={handleSubmit}>
        <FormGroup>
          <Label htmlFor="receiptDate">Дата</Label>
          <Input
            type="date"
            id="receiptDate"
            name="receiptDate"
        ...
        <Button type="submit">Создать историю особи</Button>
      </Form>
      </Container>
    </>
    )}
...
export default IndividualHistoryCreatePage;
