...
const Container = styled.div`
  ...
  width: 100%;
`
const CellHistoryCreatePage: React.FC = () => {
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    e.preventDefault();
    console.log(formData);
    const code = await cellHistoryService.create(formData)
    ...
    <>
     <div style={{
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Button type="submit">Добавить в историю клеток</Button>
      </Form>
      </Container>
    </>
  );
...
export default CellHistoryCreatePage;