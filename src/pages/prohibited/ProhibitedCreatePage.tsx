...
const Container = styled.div`
  ...
  width: 100%;
`
const ProhibitedCreatePage: React.FC = () => {
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    e.preventDefault();
    const code = await prohibitedService.createProhibited(formData)
    ...
    <>
     <div style={{
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Button type="submit">Создать запрещенное расселения</Button>
      </Form>
      </Container>
    </>
    )}
...
export default ProhibitedCreatePage;
